  ...
  return (
    <nav className={'flex items-center w-full py-4'}>
      ...
      <div className={'flex-grow w-1/3 flex justify-center'}>
        <Link to={'/'}>
          <img src="/assets/img/logos/bitwave.png" alt="bitwave logo" className={'w-12'}/>
        </Link>
      </div>
      <div className={'flex-grow flex flex-row-reverse items-center gap-4 w-1/3'}>
        <img src="/assets/img/icons/default-profile-pic.jpg" alt="profile picture" className={'w-8 rounded-full cursor-pointer'}/>
